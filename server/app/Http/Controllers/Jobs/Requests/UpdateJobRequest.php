...
class UpdateJobRequest extends FormRequest
{
    ...
    {
        return [
            'job_pr_id' => ['required', Rule::exists('jobs_pr', 'id')->whereNull('deleted_at')],
            ...
            'shifts_data.*.id' => 'nullable|exists:jobs_shifts,id',
            ...
            'old_files.*.id' => 'nullable|exists:jobs_files,id',
            'video' => 'nullable|array',
            'video.*.type' => 'nullable|integer',
            'video.*.file' => 'nullable|file',
            'video.*.link' => 'nullable|max:255',
            'old_video' => 'nullable|array',
            'old_video.*.id' => 'nullable|exists:jobs_videos,id',
        ];
    }
