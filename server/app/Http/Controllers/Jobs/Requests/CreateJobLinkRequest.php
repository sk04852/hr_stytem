...
class CreateJobLinkRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'desired_start_time' => 'required|max:100',
            ...
            'shifts_data.*.start_time' => 'nullable|date_format:H:i',
            'shifts_data.*.end_time' => 'nullable|date_format:H:i|after:shifts_data.*.start_time',
