...
class JournalReportQueryBuilder implements Builder {
    ...
    public function build() {
        $queryBuilder = $this->queryBuilder_::from('invoices as i')
                        ...
                        ->select(['i.id as invoice_id', 'i.invoice_date', 'i.invoice_number', 'i.payment_type', 'i.tax', 'i.status', 'i.discount',
                                  DB::raw('CONCAT(i.total, " ", cgs.default_currency) as total'), 'i.created_at',
